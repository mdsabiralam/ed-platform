...
define(
  ...
  function() {
    return {
      ...
      'misc.auto_update': '/misc/auto_update/<current_version_int>/<latest_version>/<latest_version_int>/<product_name>/<path:ftp_url>/',
      ...
      'file_manager.load_file': '/file_manager/load_file/',

      'file_manager.save_file': '/file_manager/save_file/',

      'workspace.adhoc_connect_server': '/misc/workspace/adhoc_connect_server',

      'workspace.layout_changed': '/misc/workspace/layout_changed',
      ...
      'settings.save_application_state': '/settings/save_application_state',

      'settings.get_application_state': '/settings/get_application_state',

      'settings.delete_application_state': '/settings/delete_application_state/',

      'settings.get_tool_data': '/settings/get_tool_data/<int:trans_id>',

      'settings.object_explorer_filter': '/settings/object_explorer_filter',
      ...
      'sqleditor.initialize_sqleditor_with_did': '/sqleditor/initialize/sqleditor/<int:trans_id>/<int:sgid>/<int:sid>/<did>',
      ...
      'sqleditor.server_cursor': '/sqleditor/server_cursor/<int:trans_id>',

      'user_management.roles': '/user_management/role/',

      'user_management.role': '/user_management/role/<int:rid>',

      'user_management.role_save': '/user_management/role/',

      'user_management.role_delete': '/user_management/role/<int:id>',
      ...
      'user_management.save_id': '/user_management/save/<int:id>',

      'user_management.all_permissions': '/user_management/all_permissions',

      'user_management.save_permissions': '/user_management/save_permissions/<int:id>',
