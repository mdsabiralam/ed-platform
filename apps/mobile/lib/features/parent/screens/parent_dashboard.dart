...
class _ParentDashboardScreenState extends State<ParentDashboardScreen> {
  ...
  Widget _buildChildSwitcher() {
    return Container(
      ...
      child: DropdownButton<String>(
        ...
        items: <String>['Rahim', 'Karim'].map<DropdownMenuItem<String>>((String value) {
  ...
  Widget _buildSummaryCards() {
    ...
    return GridView.count(
      ...
      mainAxisSpacing: 16,
      children: [
        _buildInfoCard('Attendance', data['attendance'], Icons.check_circle_outline, Colors.green),
        _buildInfoCard('Fee Status', data['feeDue'] ? 'Due' : 'Paid', Icons.receipt, data['feeDue'] ? Colors.red : Colors.teal),
        _buildInfoCard('Recent Result', data['result'], Icons.grade, Colors.blue),
      ],
    );
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Column(
               crossAxisAlignment: CrossAxisAlignment.start,
               children: [
                  Text(title, style: GoogleFonts.lato(color: Colors.white70, fontSize: 14)),
                  Text(value, style: GoogleFonts.lato(color: Colors.white, fontSize: 24, fontWeight: FontWeight.bold)),
               ],
            ),
          ],
        ),
