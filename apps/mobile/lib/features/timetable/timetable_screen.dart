...
class TimetableScreen extends StatefulWidget {
  ...
  routine; // Expecting grouped map from backend (or we group it here)
            ...
            child: Column(
              children: [
                ...
                DropdownButton<ViewMode>(
                  ...
                  items: ViewMode.values.map<DropdownMenuItem<ViewMode>>((
                    ViewMode value,
                  ) {
                ...
                if (_viewMode != ViewMode.masterView)
                  DropdownButton<String>(
                    hint: Text(
                      'Select ${_viewMode.name.replaceAll('View', '')}',
                    ),
          ...
          children: [
            ListTile(
              ...
              onTap: () {
                ...
                TimetablePdfBuilder.generateMasterView(
                  widget.routine,
                  "Master Timetable",
                );
              },
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context);
                TimetablePdfBuilder.generateSpecificView(
                  widget.routine,
                  "Timetable",
                  PdfPageFormat.a4,
                );
